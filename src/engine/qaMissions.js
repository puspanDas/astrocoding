...
`
    ...
    validateSuccess: (state) => state.x >= 340 && state.x <= 380 && state.signalsSent > 0,
...
`
    ...
    validateSuccess: (state) => state.x >= 190 && state.x <= 210 && state.signalsSent > 0,
...
`
    ...
    validateSuccess: (state) => state.signalsSent > 0,
